...
window.onload = function () {
  ...
  var _loop = function _loop(step) {
    ...
    $("#CanvasDraw".concat(step)).attr('height', h);
    $("#Image".concat(step)).attr('width', w);
    $("#Image".concat(step)).attr('height', h); //画像表示する
    ...
    function concatCanvas(_x, _x2) {
      return _concatCanvas.apply(this, arguments);
    }

    function _concatCanvas() {
      _concatCanvas = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(base, asset) {
        var can, ctx, i, image1;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 6;
                return getImagefromCanvas(asset[i]);
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/laravel/r6s_strategy/resources/js/canvas.js */"./resources/js/canvas.js");
